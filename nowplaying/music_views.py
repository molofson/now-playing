...
This module defines the interface and registry for content panes - different ways
to explore and discover content based on currently playing audio and held exploration contexts.
Supports both live updating content and user-held exploration contexts for deep discovery.
"""
