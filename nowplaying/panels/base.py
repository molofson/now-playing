...
class ContentContext:
    ...
    track_id: Optional[str] = None  # Unique track identifier
    ...
    # Enrichment data (populated by MCP services)
...
class ContentPanel(ABC):
    ...
    def handle_event(self, event: pygame.event.Event) -> bool:  # noqa: U100 - default impl, subclasses may use
        """Handle pygame events. Return True if event was consumed.

        Default implementation ignores all events. Override to handle specific events.
        """
        return False
